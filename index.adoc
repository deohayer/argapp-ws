...
** `<<f-apphelper-section-prolog,self.section_prolog>>("Description", apps[-1])`.
...
** `<<f-apphelper-section-epilog,self.section_epilog>>("Notes", apps[-1])`.
...
* `title` - A title for the section.
* `app` - An <<c-argapp-app,`App`>> to generate the text for.
